// Regenerates the baked centreline data in app/components/signature-data.ts
...
/** One recovered stroke centreline: SVG path data, arc length, stroke width. */
...
export const CENTERLINES: readonly Centerline[] = ${JSON.stringify(out, null, 2)};
`;
writeFileSync("app/components/signature-data.ts", file);
console.error("wrote app/components/signature-data.ts");
